...
function createAbortControllerEqualsTest({ _this, behavior, equalsConstructors, equalsInstances, AbortSignal1, AbortController1, AbortSignal2, AbortController2, }) {
    ...
    if (behavior) {
        describe('behavior', function () {
            const testVariants$1 = testVariants.createTestVariantsSync(({ unsubscribe, subscribe, reason, }) => {
                const onAbortArgs = [];
    ...
    if (equalsInstances) {
        describe('equalsInstances', function () {
            ...
            const testVariants$1 = testVariants.createTestVariantsSync(({ subscribe1, unsubscribe1, abort1, throwIfAborted1, subscribe2, unsubscribe2, abort2, throwIfAborted2, reason, }) => {
                helpers.test({
                    repeat: 2,
                    message: 'AbortController',
                    actual: AbortController1,
