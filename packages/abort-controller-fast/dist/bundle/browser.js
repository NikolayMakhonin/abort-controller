...
;return Object.setPrototypeOf(e,r.prototype),e.reason=n,
...
new n)}(r,t),r}(Error)
;var n=function(){},e=function(){function t(){
...
}(),i=function(){function t(){this.signal=new e}
...
;t.AbortControllerFast=i,t.AbortError=r,t.toAbortController=function(t,o){
...
return o||(o=new AbortController),t.subscribe((function(t){
o.abort(t)})),o.signal
},t.toAbortSignalFast=function(t,o){
